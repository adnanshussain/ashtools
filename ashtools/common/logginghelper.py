...
LOG_COLORS = {
    ...
    logging.INFO:     GREEN.ascii,
    logging.WARN :  ORANGE.ascii,
    logging.ERROR:    RED.ascii,
    logging.CRITICAL: RED.ascii,
    'RESET':    RESET.ascii,
}
...
info_log(f'{GREEN_BOLD_ITALIC.ascii}logginghelper loaded. logging INFO by default. Change this at any point in time by calling change_log_level(whatever_level).')